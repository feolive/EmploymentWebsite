...
<body>
    ...
    <table id="dg" title="7S整改列表" class="easyui-datagrid"
            url="SsProblemRectify/findAll"
        ...
        <thead>
            <tr>
				...
				<th data-options="field:'Export', formatter: function(value,row,index){
	   ...
	   function showRectifyProgress(id){
			   ...
			   $('#rectifyDivDg').datagrid({
	   		    ...
	   		    columns:[[
						...
						{field:'relatedPointName',title:'检查点',width:100},
		   		        {field:'standardDesc',title:'需整改事项',width:200},
			   ...
			   $.post("SsProblemRectify/findRectifyResultById",{"rectifyId":id}, function(result){
		...
		function length(id){
	    	$.post('SsProblemRectify/exportExcelResult',{
	    		title:"7S现场管理整改反馈",
	    		rectifyId:id,
	    		isGrouped:true
	    		},
